...
LPH_JIT_MAX(function() -- Main Cheat
    ...
    local pathfinding = loadstring(game:HttpGet("https://raw.githubusercontent.com/aGodBridger/robloxtest/main/pathfinding.lua"))() -- i didnt make this, i did fix it tho cuz pro
